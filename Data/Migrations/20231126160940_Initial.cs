        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => x.Id);
                    table.UniqueConstraint("AK_Images_FileRef", x => x.FileRef);
                    table.UniqueConstraint("AK_Images_Name", x => x.Name);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatUrl = table.Column<string>(type: "text", nullable: false),
                    CreatingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EditingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_Profiles_BirthdayManId",
                        column: x => x.BirthdayManId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishLists_Profiles_BirthdayManId",
                        column: x => x.BirthdayManId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiftRef = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    CreatingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EditingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletingTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_BirthdayManId",
                table: "Subscriptions",
                column: "BirthdayManId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishLists_BirthdayManId",
                table: "WishLists",
                column: "BirthdayManId");
